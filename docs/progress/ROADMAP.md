...
| ITEM-03 | Activos | Próximos eventos derivados de relaciones | PARCIAL | El ítem no almacena ni edita fechas manuales; lista evento, vencimiento documental y campo DATE por orden y urgencia | Relacionar una fuente fechada y reabrir el ítem | Unit + API + E2E + visual | CRUD de Documentos, Calendario y campos dinámicos |
| DOC-01 | Documentos | Implementar subida, versión y descarga | VISUAL MOCK | Archivo y metadatos persisten con validación | Subir, descargar y versionar | API + E2E | Almacenamiento de ficheros |
