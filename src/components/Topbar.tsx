        ...
        <div className="ml-auto flex items-center gap-2">
          <div className="relative hidden md:block">
            ...
            <input
              ...
              placeholder="Buscar activos, documentos, ubicaciones…"
              className="pl-9 pr-16 py-2 w-80 rounded-lg bg-slate-100 dark:bg-slate-800 border border-transparent focus:border-brand-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-none text-sm cursor-pointer"
            />
            <kbd className="kbd absolute right-2 top-1/2 -translate-y-1/2 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 text-slate-500 pointer-events-none">⌘K</kbd>
          </div>
