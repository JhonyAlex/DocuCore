    ...
    <section className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Tipos de documento</h2>
          <p className="text-sm text-slate-500">Gestiona los tipos de documento disponibles en {project?.name ?? 'el proyecto'}.</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button type="button" onClick={() => { setFormError(null); setFormType(null) }} className="rounded-lg bg-brand-600 px-3.5 py-2 text-sm font-medium text-white hover:bg-brand-700">＋ Nuevo tipo de documento</button>
        </div>
      </div>
