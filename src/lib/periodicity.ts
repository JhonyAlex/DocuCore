// DOC-03: periodicidad de documentos basada en el vencimiento (misma lógica que
// server/lib/periodicity.ts). El frontend precalcula el vencimiento para
// mostrarlo en el formulario (campo editable); el servidor es la fuente
// autoritativa cuando la petición no trae fecha.
